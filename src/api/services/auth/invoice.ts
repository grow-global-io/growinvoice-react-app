...
import type {
	...
	InvoiceControllerMarkedAsRejected200,
...
export const invoiceControllerFindAll = (
	...
	return authInstance<Invoice[]>({ url: `/api/invoice`, method: "GET", params, signal });
};
...
export function useInvoiceControllerOutstandingReceivable<
	TData = Awaited<ReturnType<typeof invoiceControllerOutstandingReceivable>>,
	TError = ErrorType<unknown>,
>(options: {
	query: Partial<
...
export function useInvoiceControllerFindDueToday<
	TData = Awaited<ReturnType<typeof invoiceControllerFindDueToday>>,
	TError = ErrorType<unknown>,
>(
	params: InvoiceControllerFindDueTodayParams,
...
export function useInvoiceControllerFindDueMonth<
	TData = Awaited<ReturnType<typeof invoiceControllerFindDueMonth>>,
	TError = ErrorType<unknown>,
>(
	params: InvoiceControllerFindDueMonthParams,
...
export function useInvoiceControllerTotalDue<
	TData = Awaited<ReturnType<typeof invoiceControllerTotalDue>>,
	TError = ErrorType<unknown>,
>(options: {
	query: Partial<
...
export function useInvoiceControllerInvoiceCount<
	TData = Awaited<ReturnType<typeof invoiceControllerInvoiceCount>>,
	TError = ErrorType<unknown>,
>(options: {
	query: Partial<
...
export const invoiceControllerFindDueInvoices = (
	params?: InvoiceControllerFindDueInvoicesParams,
	signal?: AbortSignal,
) => {
...
export const getInvoiceControllerFindDueInvoicesQueryKey = (
	...
	return [`/api/invoice/due`, ...(params ? [params] : [])] as const;
};
...
>(
	...
	const queryKey = queryOptions?.queryKey ?? getInvoiceControllerFindDueInvoicesQueryKey(params);

	const queryFn: QueryFunction<Awaited<ReturnType<typeof invoiceControllerFindDueInvoices>>> = ({
		signal,
	}) => invoiceControllerFindDueInvoices(params, signal);
...
export function useInvoiceControllerFindDueInvoices<
	TData = Awaited<ReturnType<typeof invoiceControllerFindDueInvoices>>,
	TError = ErrorType<unknown>,
>(
	params: undefined | InvoiceControllerFindDueInvoicesParams,
	options: {
		query: Partial<
			UseQueryOptions<Awaited<ReturnType<typeof invoiceControllerFindDueInvoices>>, TError, TData>
		> &
...
>(
	...
	const queryOptions = getInvoiceControllerFindDueInvoicesQueryOptions(params, options);
...
export const invoiceControllerFindPaidInvoices = (
	params?: InvoiceControllerFindPaidInvoicesParams,
	signal?: AbortSignal,
) => {
	return authInstance<Invoice[]>({ url: `/api/invoice/paid`, method: "GET", params, signal });
};

export const getInvoiceControllerFindPaidInvoicesQueryKey = (
	params?: InvoiceControllerFindPaidInvoicesParams,
) => {
	return [`/api/invoice/paid`, ...(params ? [params] : [])] as const;
};
...
>(
	...
	const queryKey = queryOptions?.queryKey ?? getInvoiceControllerFindPaidInvoicesQueryKey(params);

	const queryFn: QueryFunction<Awaited<ReturnType<typeof invoiceControllerFindPaidInvoices>>> = ({
		signal,
	}) => invoiceControllerFindPaidInvoices(params, signal);
...
export function useInvoiceControllerFindPaidInvoices<
	TData = Awaited<ReturnType<typeof invoiceControllerFindPaidInvoices>>,
	TError = ErrorType<unknown>,
>(
	params: undefined | InvoiceControllerFindPaidInvoicesParams,
	options: {
		query: Partial<
			UseQueryOptions<Awaited<ReturnType<typeof invoiceControllerFindPaidInvoices>>, TError, TData>
		> &
...
>(
	...
	const queryOptions = getInvoiceControllerFindPaidInvoicesQueryOptions(params, options);
...
export function useInvoiceControllerTest<
	TData = Awaited<ReturnType<typeof invoiceControllerTest>>,
	TError = ErrorType<unknown>,
>(
	id: string,
	options: {
		...
		> &
			Pick<
				DefinedInitialDataOptions<Awaited<ReturnType<typeof invoiceControllerTest>>, TError, TData>,
				"initialData"
			>;
	},
): DefinedUseQueryResult<TData, TError> & { queryKey: QueryKey };
...
export function useInvoiceControllerInvoicePublicFindOne<
	TData = Awaited<ReturnType<typeof invoiceControllerInvoicePublicFindOne>>,
	TError = ErrorType<unknown>,
>(
	id: string,
...
export const invoiceControllerMarkedAsRejected = (
	...
	return authInstance<InvoiceControllerMarkedAsRejected200 | void>({
		url: `/api/invoice/markedAsRejected`,
		method: "POST",
		params,
	});
};

export const getInvoiceControllerMarkedAsRejectedMutationOptions = <
	TError = ErrorType<unknown>,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
		Awaited<ReturnType<typeof invoiceControllerMarkedAsRejected>>,
		TError,
		{ params: InvoiceControllerMarkedAsRejectedParams },
		TContext
	>;
...
> => {
	...
	> = (props) => {
		...
		return invoiceControllerMarkedAsRejected(params);
	};

	return { mutationFn, ...mutationOptions };
};

export type InvoiceControllerMarkedAsRejectedMutationResult = NonNullable<
	Awaited<ReturnType<typeof invoiceControllerMarkedAsRejected>>
>;

export type InvoiceControllerMarkedAsRejectedMutationError = ErrorType<unknown>;

export const useInvoiceControllerMarkedAsRejected = <
	TError = ErrorType<unknown>,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
